...
@st.cache_data
def load_data():
    data = pd.read_csv('C:/Users/Laura/OneDrive/Documents/data_diseases.csv')
...
def load_additional_data():
    alzheimer_healthcare_data = pd.read_csv('C:/Users/Laura/OneDrive/alzheimer_healthcare_data.csv')
...
def load_income_data():
    alzheimer_income_data = pd.read_csv('C:/Users/Laura/OneDrive/Documents/alzheimer_income_data.csv')
